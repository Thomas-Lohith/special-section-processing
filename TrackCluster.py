...
# Reading csv file with postprocessed articles
def read_csv(file):
...
# inserting the nodes to the graph
def nodes_calc(doc):
    nodes = []
...
#histogram of the intersections (common words between papers) (x-axis the number of common words, y-axis the occurrence of this number)
